...
<main class="lg:bg-[#ffffff] lg:w-2/3 items-center justify-around max-lg:w-full lg:mx-auto flex flex-grow-1 h-fit flex-col">
    ...
    {{-- Bouton d'ajout --}}
    <button class="flex lg:absolute lg:top-64 lg:mt-3">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="[#87736a]" class="h-10 w-10">
...
<div class="flex w-full mt-3 mb-3 content-center items-center">
{{ $posts->links() }}
