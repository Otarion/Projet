...
<div class="max-lg:hidden items-center justify-center h-14 w-full">
    <div class="flex items-center h-14">
                ...
                <div class="items-center m-[6.4rem]">
                        <a href="{{ route('index')}}">
                    ...
                    {{-- Bouton de direction --}}
                <div class="space-x-[256px] flex items-baseline text-center flex-row">
            ...
            <div class="m-16 mr-14 flex flex-row justify-around space-x-10">
